...
<div class="fig-row">
  ...
  <a href="{{ $link(['status' => 'confirmed', 'overdue' => 1]) }}" class="fig bad">
    ...
    <a href="{{ $link() }}" class="fig quiet">
    <span class="f-label">Premises fined</span>
    <b class="f-value">{{ $figures['entities'] }}</b>
    <span class="f-note">
      {{ Str::plural('premises', $figures['entities']) }} carrying a fine
    </span>
  </a>
...
<section>
  ...
  <div class="desc">
    Confirmed and part-paid first, then proposed, then settled &mdash; the
